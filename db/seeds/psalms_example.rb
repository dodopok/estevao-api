...
# Psalm 1
Psalm.find_or_create_by!(number: 1, translation: 'loc_2015') do |p|
...
# Psalm 23
Psalm.find_or_create_by!(number: 23, translation: 'loc_2015') do |p|
...
# Psalm 95 (Venite)
Psalm.find_or_create_by!(number: 95, translation: 'loc_2015') do |p|
  p.title = 'Venite'
  p.verses = [
...
# Psalm 100 (Jubilate)
Psalm.find_or_create_by!(number: 100, translation: 'loc_2015') do |p|
  p.title = 'Jubilate'
  p.verses = [
...
# Compline Psalms
# Psalm 4
Psalm.find_or_create_by!(number: 4, translation: 'loc_2015') do |p|
...
# Psalm 91
Psalm.find_or_create_by!(number: 91, translation: 'loc_2015') do |p|
...
# Psalm 134
Psalm.find_or_create_by!(number: 134, translation: 'loc_2015') do |p|
