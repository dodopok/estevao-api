...
loc_2015_preferences = [
  ...
  },
  {
    key: "notifications",
    name: "Notificações",
    description: "Lembretes para os horários de oração",
    icon: "notifications_active",
    position: 5,
    preferences: [
      {
        key: "morning_prayer_notification",
        name: "Lembrete da Oração Matutina",
        description: "Receber notificação para oração matutina",
        pref_type: "toggle",
        required: false,
        default_value: "true",
        position: 1
      ...
      {
        key: "morning_prayer_time",
        name: "Horário da Oração Matutina",
        description: "Horário do lembrete da oração matutina",
        pref_type: "time",
        required: false,
        default_value: "07:00",
        position: 2,
        depends_on: { key: "morning_prayer_notification", value: true }
      },
      {
        key: "midday_prayer_notification",
        name: "Lembrete da Oração do Meio-Dia",
        description: "Receber notificação para oração do meio-dia",
        pref_type: "toggle",
        required: false,
        default_value: "false",
        position: 3
      ...
      {
        key: "midday_prayer_time",
        name: "Horário da Oração do Meio-Dia",
        description: "Horário do lembrete da oração do meio-dia",
        pref_type: "time",
        required: false,
        default_value: "12:00",
        position: 4,
        depends_on: { key: "midday_prayer_notification", value: true }
      },
      {
        key: "evening_prayer_notification",
        name: "Lembrete da Oração Vespertina",
        description: "Receber notificação para oração vespertina",
        pref_type: "toggle",
        required: false,
        default_value: "true",
        position: 5
      ...
      {
        key: "evening_prayer_time",
        name: "Horário da Oração Vespertina",
        description: "Horário do lembrete da oração vespertina",
        pref_type: "time",
        required: false,
        default_value: "18:00",
        position: 6,
        depends_on: { key: "evening_prayer_notification", value: true }
      },
      {
        key: "compline_notification",
        name: "Lembrete das Completas",
        description: "Receber notificação para completas",
        pref_type: "toggle",
        required: false,
        default_value: "false",
        position: 7
      ...
      {
        key: "compline_time",
        name: "Horário das Completas",
        description: "Horário do lembrete das completas",
        pref_type: "time",
        required: false,
        default_value: "21:00",
        position: 8,
        depends_on: { key: "compline_notification", value: true }
      }
    ]
  },
  {
