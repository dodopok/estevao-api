...
[
  ...
  LiturgicalText.find_or_create_by!(slug: text[:slug], version: 'loc_2015') do |lt|
...
# Confessions
LiturgicalText.find_or_create_by!(slug: 'confession_long', version: 'loc_2015') do |lt|
...
# Absolution
LiturgicalText.find_or_create_by!(slug: 'absolution', version: 'loc_2015') do |lt|
...
# Invocation
LiturgicalText.find_or_create_by!(slug: 'invocation', version: 'loc_2015') do |lt|
...
# Canticles
LiturgicalText.find_or_create_by!(slug: 'venite', version: 'loc_2015') do |lt|
...
LiturgicalText.find_or_create_by!(slug: 'jubilate', version: 'loc_2015') do |lt|
  lt.category = 'canticle'
  lt.content = <<~TEXT
...
# Creeds
LiturgicalText.find_or_create_by!(slug: 'apostles_creed', version: 'loc_2015') do |lt|
  lt.category = 'creed'
  lt.content = <<~TEXT
...
# Lord's Prayer
LiturgicalText.find_or_create_by!(slug: 'lords_prayer_traditional', version: 'loc_2015') do |lt|
  lt.category = 'prayer'
  lt.content = <<~TEXT
...
# Collects
LiturgicalText.find_or_create_by!(slug: 'collect_peace', version: 'loc_2015') do |lt|
  lt.category = 'prayer'
  lt.content = <<~TEXT
...
LiturgicalText.find_or_create_by!(slug: 'collect_grace', version: 'loc_2015') do |lt|
  lt.category = 'prayer'
  lt.content = <<~TEXT
...
LiturgicalText.find_or_create_by!(slug: 'general_thanksgiving', version: 'loc_2015') do |lt|
  lt.category = 'prayer'
  lt.content = <<~TEXT
...
LiturgicalText.find_or_create_by!(slug: 'chrysostom_prayer', version: 'loc_2015') do |lt|
  lt.category = 'prayer'
  lt.content = <<~TEXT
...
# Dismissal
LiturgicalText.find_or_create_by!(slug: 'dismissal', version: 'loc_2015') do |lt|
