...
celebrations = [
  ...
  { name: "Natal", celebration_type: "principal_feast", liturgical_color: "branco", fixed_month: 12, fixed_day: 25, rank: 1, can_be_transferred: false, post_slug: "season-christmas", person_type: "event", gender: "neutral" },
  { name: "Vigília de Natal", celebration_type: "principal_feast", liturgical_color: "branco", fixed_month: 12, fixed_day: 24, rank: 1, can_be_transferred: false, post_slug: "season-christmas", person_type: "event", gender: "neutral" },
  ...
  { name: "Segunda-Feira Santa", celebration_type: "major_holy_day", liturgical_color: "roxo", movable: true, calculation_rule: "monday_holy_week", rank: 50, can_be_transferred: false, post_slug: "celebration-holy-week", person_type: "event", gender: "neutral" },
  { name: "Terça-Feira Santa", celebration_type: "major_holy_day", liturgical_color: "roxo", movable: true, calculation_rule: "tuesday_holy_week", rank: 50, can_be_transferred: false, post_slug: "celebration-holy-week", person_type: "event", gender: "neutral" },
  { name: "Quarta-Feira Santa", celebration_type: "major_holy_day", liturgical_color: "roxo", movable: true, calculation_rule: "wednesday_holy_week", rank: 50, can_be_transferred: false, post_slug: "celebration-holy-week", person_type: "event", gender: "neutral" },
  ...
  { name: "Sábado Santo", celebration_type: "major_holy_day", liturgical_color: "roxo", movable: true, calculation_rule: "holy_saturday", rank: 50, can_be_transferred: false, post_slug: "celebration-holy-week", person_type: "event", gender: "neutral" },
