# ================================================================================
# SEED DE CELEBRAÇÕES (Principal Feasts, Festivals e Lesser Feasts) para LOC 2019
# Carrega dados dos arquivos JSON e insere/atualiza no banco
# ================================================================================

Rails.logger.info "📅 Loading celebrations for LOC 2019..."
...
def normalize_celebration(data, prayer_book_id, default_rank_base)
...

  {
    ...
    liturgical_color: data['liturgical_color'] || 'white',
