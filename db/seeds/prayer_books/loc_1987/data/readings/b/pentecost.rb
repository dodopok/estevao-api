# ================================================================================
# LEITURAS - PENTECOSTES E SEMANA PASCAL - LOC 1987 - ANO B
# ================================================================================

Rails.logger.info "📖 Carregando leituras de Pentecostes (LOC 1987) - Ano B..."
...
pentecost_readings = [
  {
    ...
    first_reading: "Gênesis 11:1-9 ou Êxodo 19:1-9,16-20;20:18-20 ou Ezequiel 37:1-14 ou Joel 2:28-32",
  ...
  },
  {
    ...
    cycle: "B",
    service_type: "eucharist",
    first_reading: "Atos 2:1-11 ou Isaías 44:1-8",
...
Rails.logger.info "\n✅ #{count} leituras de Pentecostes (Ano B) criadas"
