# ================================================================================
# LEITURAS - SEMANA SANTA E PÁSCOA - LOC 1987 - ANO B
# ================================================================================

Rails.logger.info "📖 Carregando leituras da Semana Santa e Páscoa (LOC 1987) - Ano B..."
...
holy_week = [
  {
    ...
    first_reading: "Marcos 11:1-11a",
    psalm: "118:19-29",
    second_reading: nil,
    gospel: "Marcos 11:1-11a"
  },
  {
    ...
    gospel: "Marcos (14:32-72) 15:1-39(40-47)"
  },
  {
...
Rails.logger.info "\n✅ #{count} leituras da Semana Santa/Páscoa (Ano B) criadas"
