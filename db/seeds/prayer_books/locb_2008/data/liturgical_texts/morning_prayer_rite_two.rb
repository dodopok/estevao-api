...
LiturgicalText.find_or_create_by!(slug: 'morning_2_confession_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
...
LiturgicalText.find_or_create_by!(slug: 'morning_2_absolution_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
...
LiturgicalText.find_or_create_by!(slug: 'morning_2_lords_prayer_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
  text.title = 'Oração do Senhor'
  text.content = nil
...
LiturgicalText.find_or_create_by!(slug: 'morning_2_morning_prayer_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
  text.title = 'Oração Matutina'
  text.content = nil
  text.category = 'morning_prayer'
  text.speaker = nil
end
...
# Responso
LiturgicalText.find_or_create_by!(slug: 'morning_2_response_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
  text.title = 'Responso'
  text.content = nil
...
LiturgicalText.find_or_create_by!(slug: 'morning_2_venite_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
  text.title = 'Venite, exultemus Domino (Sl 95)'
  text.content = nil
...
LiturgicalText.find_or_create_by!(slug: 'morning_2_psalms_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
  text.title = 'Salmodia'
  text.content = nil
...
LiturgicalText.find_or_create_by!(slug: 'morning_2_ot_reading_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
...
LiturgicalText.find_or_create_by!(slug: 'morning_2_te_deum_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
...
LiturgicalText.find_or_create_by!(slug: 'morning_2_nt_reading_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
...
LiturgicalText.find_or_create_by!(slug: 'morning_2_sermon_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
  text.title = 'Sermão'
  text.content = nil
  text.category = 'sermon'
  text.speaker = nil
end
...
LiturgicalText.find_or_create_by!(slug: 'morning_2_benedictus_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
...
LiturgicalText.find_or_create_by!(slug: 'morning_2_jubilate_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
...
LiturgicalText.find_or_create_by!(slug: 'morning_2_creed_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
  text.title = 'O Credo dos Apóstolos'
  text.content = nil
  text.category = 'creed'
  text.speaker = nil
end
...
LiturgicalText.find_or_create_by!(slug: 'morning_2_prayers_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
  text.title = 'Orações'
  text.content = nil
...
# Sufrágio
LiturgicalText.find_or_create_by!(slug: 'morning_2_suffrage_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
  text.title = 'Sufrágio'
  text.content = nil
...
LiturgicalText.find_or_create_by!(slug: 'morning_2_collect_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
...
LiturgicalText.find_or_create_by!(slug: 'morning_2_collect_peace_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
...
LiturgicalText.find_or_create_by!(slug: 'morning_2_collect_grace_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
...
LiturgicalText.find_or_create_by!(slug: 'morning_2_hymn_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
  text.title = 'Hino'
  text.content = nil
  text.category = 'hymn'
...
LiturgicalText.find_or_create_by!(slug: 'morning_2_other_prayers_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
...
LiturgicalText.find_or_create_by!(slug: 'morning_2_conclusion_title', prayer_book_id: prayer_book.id) do |text|
  text.language = 'pt-BR'
