...
commemorations = [
  ...
  { name: "Martírio dos reformados franceses Jean de Bourdel, Mathieu Verneuil e Pierre de Bourdon", fixed_month: 2, fixed_day: 9, description: "Baía de Guanabara, 1558", post_slug: "celebration-martyrs-of-guanabara", person_type: "plural", gender: "mixed" },
  ...
  { name: "Publicação das Institutas da Religião Cristã", fixed_month: 8, fixed_day: 23, description: "João Calvino, 1535", post_slug: "celebration-institutes-john-calvin", person_type: "event", gender: "neutral" },
  ...
  { name: "John Coleridge Patteson", fixed_month: 9, fixed_day: 20, description: "Bispo da Melanésia, e seus companheiros, mártires, 1871", post_slug: "celebration-john-coleridge-patteson", person_type: "plural", gender: "mixed" },
  ...
  { name: "Clemente", fixed_month: 11, fixed_day: 23, description: "Bispo de Roma, 100, e Columbano, abade de Bóbio, Itália, 615", post_slug: "celebration-clement-of-rome", person_type: "singular", gender: "masculine" },
