    ...
    module Loc2019
      class Compline < Base
        ...
        def build_thanksgiving
          # Ação de Graças Geral opcional
          gt = fetch_liturgical_text("general_thanksgiving")
          lines = []
          lines << line_item("Antes do encerramento do Ofício, uma ou ambas as seguintes orações podem ser usadas.", type: "rubric")
          lines << line_item("A AÇÃO DE GRAÇAS GERAL", type: "heading")
          lines << line_item("Oficiante e Povo", type: "rubric")
