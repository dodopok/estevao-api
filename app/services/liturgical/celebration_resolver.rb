...
module Liturgical
  ...
  class Liturgical::CelebrationResolver
    ...
    CALCULATION_RULE_TO_DATE_REFERENCES = {
      ...
      "easter_minus_6_days" => %w[holy_monday monday_holy_week],
      "holy_monday" => %w[holy_monday monday_holy_week],
      "easter_minus_5_days" => %w[holy_tuesday tuesday_holy_week],
      "holy_tuesday" => %w[holy_tuesday tuesday_holy_week],
      "easter_minus_4_days" => %w[holy_wednesday wednesday_holy_week],
      "holy_wednesday" => %w[holy_wednesday wednesday_holy_week],
      "easter_minus_3_days" => %w[maundy_thursday holy_thursday],
      "maundy_thursday" => %w[maundy_thursday holy_thursday],
      "easter_minus_2_days" => %w[good_friday],
      "good_friday" => %w[good_friday],
      "easter_minus_1_days" => %w[holy_saturday holy_saturday_vigil],
      "easter_minus_1_day" => %w[holy_saturday holy_saturday_vigil],
      "holy_saturday" => %w[holy_saturday holy_saturday_vigil],
      "easter" => %w[easter_principal_office easter_first_office easter_sunday easter_day easter],
      "easter_plus_39_days" => %w[ascension ascension_day],
      "ascension" => %w[ascension ascension_day],
      "easter_plus_49_days" => %w[pentecost_day pentecost whitsunday pentecost_sunday],
      ...
      "whitsun_monday" => %w[monday_in_whitsun_week whitsun_monday],
      "whitsun_tuesday" => %w[tuesday_in_whitsun_week whitsun_tuesday]
    }.freeze
