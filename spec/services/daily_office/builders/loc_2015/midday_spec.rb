...
RSpec.describe DailyOffice::Builders::Loc2015::Midday do
  ...
  let(:test_class) do
    Class.new(DailyOffice::Builders::Loc2015Builder) do
      include DailyOffice::Builders::Loc2015::Midday
    end
  end
  ...
  let(:builder) { test_class.new(date: date, office_type: :midday) }
  ...
  describe '#assemble_midday_prayer' do
    it 'returns full midday prayer structure' do
      modules = builder.assemble_midday_prayer
  ...
  describe '#build_midday_opening' do
    it 'returns opening module structure' do
      result = builder.build_midday_opening
  ...
  describe '#build_midday_invitation' do
    it 'returns invitation module structure' do
      result = builder.build_midday_invitation
    ...
    it 'uses Lent-specific invitation during Lent' do
      ...
      builder.build_midday_invitation
  ...
  describe '#build_midday_psalms_title' do
    it 'returns psalms title module structure' do
      result = builder.build_midday_psalms_title
  ...
  describe '#build_midday_psalms' do
    it 'returns psalms module structure' do
      result = builder.build_midday_psalms
  ...
  describe '#build_midday_readings' do
    it 'returns readings module structure' do
      result = builder.build_midday_readings
  ...
  describe '#build_midday_prayer' do
    it 'returns prayer module structure' do
      result = builder.build_midday_prayer
  ...
  describe '#build_midday_dismissal' do
    it 'returns dismissal module structure' do
      result = builder.build_midday_dismissal
